...
These are the internet-tab's I found on my devices, which I now closed. I'll keep them for reference, but I doubt I'll need them again. The list is slightly redacted.

I used [these instructions](https://www.idownloadblog.com/2025/10/17/copy-all-open-tab-links-safari/#On-iPhone) (I'm using Safari on my Apple devices). With the use of an editor and macro's, I converted the list to MarkDown. However, the iPhone list didn't come with titles, so I wrote a [simple Python script](https://gist.github.com/doekman/121cc8e71368aaf2396f97b232b58f2a) to fetch the titles. I did get around 10 `403 Forbidden` responses, they probably thought I was an AI crawler. I fixed the titles by hand.
...
- [Vimeo](https://vimeo.com/showcase/9459437/video/838408969/embed)
- [https://www.templatemaker.nl/en/](https://www.templatemaker.nl/en/) -- (exception when retrieving: HTTPSConnectionPool(host='www.templatemaker.nl', port=443): Max retries exceeded with url: /en/ (Caused by SSLError(SSLCertVerificationError(1, '[SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: unable to get local issuer certificate (_ssl.c:1081)'))))
...
- [jenny odell â¢ writing](https://jennyodell.com/writing.html)
...
- [NeoFinder â The Digital Asset Manager for macOS and iOS](https://www.cdfinder.de/index.html)
...
- [https://www.amazon.com/Body-Keeps-Score-Healing-Trauma/dp/0143127748](https://www.amazon.com/Body-Keeps-Score-Healing-Trauma/dp/0143127748) -- 500 Internal Server Error
...
- [FediMeteo: How a Tiny â¬4 FreeBSD VPS Became a Global Weather Service for Thousands - IT Notes](https://it-notes.dragas.net/2025/02/26/fedimeteo-how-a-tiny-freebsd-vps-became-a-global-weather-service-for-thousands/)
...
- [https://decorrespondent.nl/16100/de-zwakke-plek-van-de-verenigde-staten-vind-je-op-zee/ebd85e6c-351c-00c5-10c2-b4db9c79ee42](https://decorrespondent.nl/16100/de-zwakke-plek-van-de-verenigde-staten-vind-je-op-zee/ebd85e6c-351c-00c5-10c2-b4db9c79ee42) -- 500 Internal Server Error
...
- [Studio Management - Client](https://client.studiomanagement.io/galleries/KeTjGNpFzTmgiiQ8wBZc?view=galleries&id=KeTjGNpFzTmgiiQ8wBZc&hash=00af15c97c64398947557bf6c2fc0299)
- [Studio Management - Client](https://client.studiomanagement.io/shoots/KeTjGNpFzTmgiiQ8wBZc?view=portal&id=R2Q9QCeheTp7juWgQGkQ)
- [Studio Management - Client](https://client.studiomanagement.io/galleries/KeTjGNpFzTmgiiQ8wBZc?view=galleries&id=KeTjGNpFzTmgiiQ8wBZc&hash=00af15c97c64398947557bf6c2fc0299)
...
- [Deen Design Zandbak is under construction](https://gwij.nl/)
